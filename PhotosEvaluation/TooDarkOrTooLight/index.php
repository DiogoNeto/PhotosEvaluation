...
<body>
	...
	<h3 align="center">Muito escuro ou muito claro?</h3>
<div id="container">
	<!--Ajuda-->
	<div id="div1" style="display:none;" style="background-color: #F0F0F0;" width="100%" height="100%">
		<table class="table" width="100%" height="500px;">
			<tr>
				...
				<td align="center" width="50%"><div align="left"><img style="border:5px solid #00ff00; height: 500px;" src="../help_images/TooDark.jpg"></div></td>
			<tr>
		</table>
		<table align="center" width="100%">
			<tr>
				<td><p align="center">Nestas imagens deverá avaliar se o nível de luminosidade se encontra demasiado escuro ou demasiado claro. Caso se encontre com uma luminosidade adequada, clique em não.</p></td>
			</tr>
		</table>
	</div>
